<%
'Februari 2014 - Version 1.17 by Gerrit van Kuipers - aspJSON
Class HepsiPayJson
	Public data
	...
	Private Function GetDict(objDict)
		dim aj_item, aj_keyvals, aj_label, aj_dicttype, pElements()
		For Each aj_item In objDict
			Select Case TypeName(objDict.Item(aj_item))
				...
				Case "Variant()"
					Dim pElement, Cursor : Cursor = 0 : ReDim pElements(UBOUND(objDict.Item(aj_item)))
